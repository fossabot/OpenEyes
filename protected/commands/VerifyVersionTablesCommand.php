...
class VerifyVersionTablesCommand extends CConsoleCommand
{
    ...
    public function fieldsMatch($table)
    {
        ...
        foreach ($_table->columns as $column => $properties) {
            ...
            } elseif ($_table_version->columns[$column]->dbType != $properties->dbType) {
        ...
        */
        ...
        } elseif ($_table_version->columns['version_date']->dbType != 'datetime') {
        ...
        } elseif (!in_array($_table_version->columns['version_id']->dbType, array('int(11)', 'int(10) unsigned'))) {
