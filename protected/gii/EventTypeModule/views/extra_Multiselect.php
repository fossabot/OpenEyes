<div style="margin-top: 8px;">
	Multi select method:&nbsp;&nbsp;&nbsp;<input type="radio" class="multiSelectMethodSelector" name="multiSelectMethod<?php echo $element_num?>Field<?php echo $field_num?>" value="0" <?php if (@$_POST['multiSelectMethod'.$element_num.'Field'.$field_num] === '0') {
    ?> checked="checked" <?php 
}?>/> Enter values
	&nbsp;&nbsp;
	<input type="radio" class="multiSelectMethodSelector" name="multiSelectMethod<?php echo $element_num?>Field<?php echo $field_num?>" value="1" <?php if (@$_POST['multiSelectMethod'.$element_num.'Field'.$field_num] === '1') {
    ?> checked="checked" <?php 
...
} elseif (@$_POST['multiSelectMethod'.$element_num.'Field'.$field_num] === '1') {
