...
<div class="box admin">
    ...
    ?>
			...
			<tfoot>
				<tr>
					<td colspan="3">
						<?php echo EventAction::button('Add', 'add_commissioning_body_type', array(), array('class' => 'small'))->toHtml()?>
						<?php echo EventAction::button('Delete', 'delete_commissioning_body_type', array(), array('class' => 'small'))->toHtml()?>
					</td>
				</tr>
			</tfoot>
		</table>
