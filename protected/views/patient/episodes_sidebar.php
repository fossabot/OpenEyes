...
<aside class="column sidebar episodes-and-events">
    ...
    ?>
						...
						<a href="#" class="toggle-trigger toggle-<?php if ((!$current_episode || $current_episode->id != $episode->id) && $episode->hidden) {
    ?>show<?php 
} else {
    ?>hide<?php 
}
    ?>">
						...
						<!-- Episode event icons -->
						<ol class="events-overview" <?php  if ($episode->hidden) {
    ...
    ?>
						...
						<!-- Episode events -->
						<div <?php if ($episode->hidden) {
    ?>class="events-container hide"<?php 
} else {
    ?>class="events-container show"<?php 
}
    ?>>
    ...
    ?>
											...
											<span class="event-date <?php echo ($event->isEventDateDifferentFromCreated())?' ev_date':'' ?>"> <?php echo $event->event_date? $event->NHSDateAsHTML('event_date') : $event->NHSDateAsHTML('created_date');
    ?></span>
										</a>
    ...
    ?>
					...
					<div class="episode_details hide" id="episode-details-<?php echo $episode->id ?>">
						<div class="row"><span class="label">Start date:</span><?php echo $episode->NHSDate('start_date');
    ?></div>
