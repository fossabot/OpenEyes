...
<div class="row">
    ...
    ?>
					<tr id="r<?php echo $result->id?>" class="clickable">
						...
						<td><?php echo date("d/m/Y", strtotime($result->dob));
    ?></td>
    ...
    ?>">
										<a href="<?php echo Yii::app()->createUrl('patient/search', $search_terms + array('page_num' => $i, 'sort_by' => $sort_by, 'sort_dir' => $sort_dir));
    ?>"><?php echo $from;
    ?> - <?php echo $to;
    ?></a>
									</li>
