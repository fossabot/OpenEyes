...

{
	...
	protected $elements = array (
			'unbookedProcedure' => array (
					'xpath' => "//input[contains(@value, 'unbooked')]" 
			),
			'createConsentForm' => array (
					'xpath' => "//*[@class='button-bar right']//*[@id='et_save']" 
			),
			'consentType' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Type_type_id']" 
			),
			'rightEye' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Procedure_eye_id_2']" 
			),
			'bothEyes' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Procedure_eye_id_3']" 
			),
			'leftEyes' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Procedure_eye_id_1']" 
			),
			'commonProcedure' => array (
					'xpath' => "//*[@id='select_procedure_id_procedures']" 
			),
			'procedureType' => array (
					'xpath' => "//input[@id='autocomplete_procedure_id_procedures']" 
			),
			'chooseLaser' => array (
					'xpath' => "//a[contains(text(),'Laser iridoplasty')]" 
			),
			'anaestheticTypeLA' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Procedure_anaesthetic_type_id_3']" 
			),
			'anaestheticTypeLAC' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Procedure_anaesthetic_type_id_2']" 
			),
			'permissionsImagesNO' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Permissions_images_id_2']" 
			),
			'permissionsImagesYES' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Permissions_images_id_1']" 
			),
			'informationLeaflet' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Other_information']" 
			),
			'anaestheticLeaflet' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Other_anaesthetic_leaflet']" 
			),
			'witnessRequired' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Other_witness_required']" 
			),
			'witnessName' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Other_witness_name']" 
			),
			'interpreterRequired' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Other_interpreter_required']" 
			),
			'interpreterName' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Other_interpreter_name']" 
			),
			'supplementaryConsent' => array (
					'xpath' => "//*[@id='Element_OphTrConsent_Other_include_supplementary_consent']" 
			),
			'saveConsentForm' => array (
					'xpath' => "//*[@id='et_save']" 
			),
			'saveConsentFormDraft' => array (
					'xpath' => "//*[@id='et_save_draft']" 
			),
			'saveConsentFormOK' => array (
					'xpath' => "//*[@id='flash-success']" 
			),
			'test' => array (
					'xpath' => "//*[@id='div_Element_OphTrConsent_Other_anaesthetic_leaflet']" 
			),
			'additionalProcedure' => array (
	...
	public function validationMessagesError() {
		return ( bool ) $this->find ( 'xpath', $this->getElement ( 'benefitValidationError' )->getXpath () ) && ( bool ) $this->find ( 'xpath', $this->getElement ( 'riskValidationError' )->getXpath () ) && ( bool ) $this->find ( 'xpath', $this->getElement ( 'procedureValidationError' )->getXpath () );
	}
